...
const Payment = () => {
   return (
      <Layout>
         <ProfileLayout>
            <h4 className="text-gray-dark font-semibold mb-8">Payment Info</h4>
            <div className="flex justify-between items-center text-md mb-4">
               <h3 className="text-lg">Payment Cards</h3>
               <span className="text-blue cursor-pointer">Add Card</span>
            </div>
            <div className="flex flex-col">
               <div className="bg-gray-light h-32 w-full flex-col">
                  ...
                  <div className="text-md font-semibold h-16 flex items-center justify-between px-8">
                     ...
                     <div>
                        <span className="text-blue ml-8 cursor-pointer border-blue p-2">
                           Default
                        </span>
                        <span className="text-blue ml-8 cursor-pointer">
                           Edit
                        </span>
                        <span className="text-red ml-8 cursor-pointer">
                           Remove
                        </span>
                     </div>
                  </div>
